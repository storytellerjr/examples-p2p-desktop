...
# user2: join room
pear run --store /tmp/live-cam-user2 . --name user2 --invite <invite>
```
...
# user1: create room + print invite
pear run --store /tmp/live-cam-user1 <pear-link> --name user1

# user2: join room
pear run --store /tmp/live-cam-user2 <pear-link> --name user2 --invite <invite>
```

## Troubleshoot
Use `--reset` to reset everything, e.g.
```shell
pear run --store /tmp/live-cam-user1 . --name user1 --reset
```
