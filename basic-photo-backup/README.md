...
pear run --store /tmp/photo-backup-user1 . --name user1

# user2: join room
pear run --store /tmp/photo-backup-user2 . --name user2 --invite <invite>
```
...
```shell
pear run --store /tmp/photo-backup-user1 . --name user1 --reset
```
